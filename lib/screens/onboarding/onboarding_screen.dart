...
const _slides = [
  ...
  _Slide(
    ...
    titulo: 'Caja con folio de cada venta',
    texto: 'Cada venta queda numerada por cajero — sabes quién cobró qué y cuándo, sin dudas al cerrar caja.',
  ),
  _Slide(
    icon: Icons.storefront,
    titulo: 'Todo tu negocio en un solo lugar',
    texto: 'Ventas, caja, proveedores y reportes — funciona sin depender de internet.',
  ),
];
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(colors: [AppColors.harvest, AppColors.harvestDim], begin: Alignment.topLeft, end: Alignment.bottomRight),
                            borderRadius: BorderRadius.circular(28),
                            boxShadow: [BoxShadow(color: AppColors.harvest.withValues(alpha: 0.35), blurRadius: 28, offset: const Offset(0, 12))],
                          ),
            ...
            Row(
              ...
              children: List.generate(_slides.length, (i) {
                ...
                return AnimatedContainer(
                  ...
                  width: activo ? 22 : 8,
                  height: 8,
                  decoration: BoxDecoration(color: activo ? AppColors.olive : Colors.white24, borderRadius: BorderRadius.circular(4)),
                );
              }),
            ),
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: AppColors.harvest, foregroundColor: Colors.white, minimumSize: const Size.fromHeight(52), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
